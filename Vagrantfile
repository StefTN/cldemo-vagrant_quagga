...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "oob-mgmt-server" do |oob_mgmt_server|
    ...
    config.vm.define "oob-mgmt-switch" do |oob_mgmt_switch|
        ...
        oob_mgmt_switch.vm.box = "CumulusCommunity/cumulus-vx"
            ...
            # Local_Interface: swp14
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_54", auto_config: false


            # Local_Interface: swp15
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_57", auto_config: false
  ...
  config.vm.define "exit01" do |exit01|
      ...
      exit01.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          exit02.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_58", auto_config: false


          exit02.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_55", auto_config: false
  ...
  config.vm.define "exit02" do |exit02|
      ...
      exit02.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          exit02.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_59", auto_config: false

          exit02.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_56", auto_config: false
  ...
  config.vm.define "internet" do |internet|
      ...
      internet.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          internet.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_54", auto_config: false

          # Local_Interface: swp1
          internet.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_55", auto_config: false

          # Local_Interface: swp2
          internet.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_56", auto_config: false

      # Disabling the default synced folder
      internet.vm.synced_folder ".", "/vagrant", disabled: true

      # Run Any Extra Config
      internet.vm.provision :shell , path: "./helper_scripts/internet_config.sh"
      ...
      # Run Postconfig
      internet.vm.provision :shell , inline: "ifreload -a"
  end

  ##### DEFINE VM for edge01 #####
  config.vm.define "edge01" do |edge01|
      edge01.vm.provider "virtualbox" do |v|
        v.name = "edge01"
        v.memory = 400
      end
      edge01.vm.hostname = "edge01"
      edge01.vm.box = "boxcutter/ubuntu1404"

          # Local_Interface: eth0
          edge01.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_57", auto_config: false, :mac => "A00000000051"

          # Local_Interface: eth1
          edge01.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_58", auto_config: false

          # Local_Interface: eth2
          edge01.vm.network "private_network", virtualbox__intnet: "net_#{wbid}_59", auto_config: false

      # Disabling the default synced folder
      edge01.vm.synced_folder ".", "/vagrant", disabled: true

      # UBUNTU DEVICES ONLY: Shorten Boot Process - remove "Wait for Network"
      edge01.vm.provision :shell , inline: "sudo sed -i 's/sleep [0-9]*/sleep 1/' /etc/init/failsafe.conf"

      # Run Any Extra Config
      edge01.vm.provision :shell , path: "./helper_scripts/pre_config.sh"

      # Apply the interface re-map
      edge01.vm.provision "file", source: "./helper_scripts/rename_eth_swp", destination: "/home/vagrant/rename_eth_swp"
      edge01.vm.provision "file", source: "./helper_scripts/autogenerated/edge01_remap_eth", destination: "/home/vagrant/remap_eth"
      edge01.vm.provision :shell , inline: "mv /home/vagrant/rename_eth_swp /etc/init.d/rename_eth_swp"
      edge01.vm.provision :shell , inline: "mv /home/vagrant/remap_eth /etc/default/remap_eth"
      edge01.vm.provision :shell , inline: "chmod 755 /etc/init.d/rename_eth_swp"
      edge01.vm.provision :shell , inline: "sudo sed -i '/exit 0/d' /etc/rc.local "
      edge01.vm.provision :shell , inline: "sudo echo '/etc/init.d/rename_eth_swp start' >> /etc/rc.local "
      edge01.vm.provision :shell , inline: "sudo echo 'exit 0' >> /etc/rc.local "
      edge01.vm.provision :shell , inline: "/etc/init.d/rename_eth_swp verbose"

      edge01.vm.provider "virtualbox" do |vbox|
        vbox.customize ['modifyvm', :id, '--nicpromisc2', 'allow-vms']
        vbox.customize ['modifyvm', :id, '--nicpromisc3', 'allow-vms']
        vbox.customize ['modifyvm', :id, '--nicpromisc4', 'allow-vms']
        vbox.customize ["modifyvm", :id, "--nictype2", "virtio"]
      ...
      # Run Postconfig
      edge01.vm.provision :shell , path: "./helper_scripts/post_config_server.sh"
  end
