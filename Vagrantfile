...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "oob-mgmt-server" do |oob_mgmt_server|
      ...
      oob_mgmt_server.vm.box = "boxcutter/ubuntu1404"
          ...
          oob_mgmt_server.vm.network "private_network", virtualbox__intnet: 'wbXnet41', auto_config: false
    ...
    config.vm.define "oob-mgmt-switch" do |oob_mgmt_switch|
        ...
        oob_mgmt_switch.vm.box = "CumulusCommunity/cumulus-vx"
            ...
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet41', auto_config: false

            # Local_Interface: swp2 Topology_File_Line(42): "server01":"eth0" -- "oob-mgmt-switch":"swp2"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet42', auto_config: false

            # Local_Interface: swp3 Topology_File_Line(43): "server02":"eth0" -- "oob-mgmt-switch":"swp3"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet43', auto_config: false

            # Local_Interface: swp4 Topology_File_Line(44): "server03":"eth0" -- "oob-mgmt-switch":"swp4"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet44', auto_config: false

            # Local_Interface: swp5 Topology_File_Line(45): "server04":"eth0" -- "oob-mgmt-switch":"swp5"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet45', auto_config: false

            # Local_Interface: swp6 Topology_File_Line(46): "leaf01":"eth0" -- "oob-mgmt-switch":"swp6"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet46', auto_config: false

            # Local_Interface: swp7 Topology_File_Line(47): "leaf02":"eth0" -- "oob-mgmt-switch":"swp7"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet47', auto_config: false

            # Local_Interface: swp8 Topology_File_Line(48): "leaf03":"eth0" -- "oob-mgmt-switch":"swp8"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet48', auto_config: false

            # Local_Interface: swp9 Topology_File_Line(49): "leaf04":"eth0" -- "oob-mgmt-switch":"swp9"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet49', auto_config: false

            # Local_Interface: swp10 Topology_File_Line(50): "spine01":"eth0" -- "oob-mgmt-switch":"swp10"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet50', auto_config: false

            # Local_Interface: swp11 Topology_File_Line(51): "spine02":"eth0" -- "oob-mgmt-switch":"swp11"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet51', auto_config: false

            # Local_Interface: swp12 Topology_File_Line(52): "exit01":"eth0" -- "oob-mgmt-switch":"swp12"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet52', auto_config: false

            # Local_Interface: swp13 Topology_File_Line(53): "exit02":"eth0" -- "oob-mgmt-switch":"swp13"
            oob_mgmt_switch.vm.network "private_network", virtualbox__intnet: 'wbXnet53', auto_config: false
  ...
  config.vm.define "server01" do |server01|
      ...
      server01.vm.box = "boxcutter/ubuntu1404"
          ...
          server01.vm.network "private_network", virtualbox__intnet: 'wbXnet42', auto_config: false, :mac => "A00000000031"

          # Local_Interface: eth1 Topology_File_Line(15): "server01":"eth1" -- "leaf01":"swp1"
          server01.vm.network "private_network", virtualbox__intnet: 'wbXnet15', auto_config: false

          # Local_Interface: eth2 Topology_File_Line(16): "server01":"eth2" -- "leaf02":"swp1"
          server01.vm.network "private_network", virtualbox__intnet: 'wbXnet16', auto_config: false
  ...
  config.vm.define "server02" do |server02|
      ...
      server02.vm.box = "boxcutter/ubuntu1404"
          ...
          server02.vm.network "private_network", virtualbox__intnet: 'wbXnet43', auto_config: false, :mac => "A00000000032"

          # Local_Interface: eth1 Topology_File_Line(17): "server02":"eth1" -- "leaf01":"swp2"
          server02.vm.network "private_network", virtualbox__intnet: 'wbXnet17', auto_config: false

          # Local_Interface: eth2 Topology_File_Line(18): "server02":"eth2" -- "leaf02":"swp2"
          server02.vm.network "private_network", virtualbox__intnet: 'wbXnet18', auto_config: false
  ...
  config.vm.define "server03" do |server03|
      ...
      server03.vm.box = "boxcutter/ubuntu1404"
          ...
          server03.vm.network "private_network", virtualbox__intnet: 'wbXnet44', auto_config: false, :mac => "A00000000033"

          # Local_Interface: eth1 Topology_File_Line(19): "server03":"eth1" -- "leaf03":"swp1"
          server03.vm.network "private_network", virtualbox__intnet: 'wbXnet19', auto_config: false

          # Local_Interface: eth2 Topology_File_Line(20): "server03":"eth2" -- "leaf04":"swp1"
          server03.vm.network "private_network", virtualbox__intnet: 'wbXnet20', auto_config: false
  ...
  config.vm.define "server04" do |server04|
      ...
      server04.vm.box = "boxcutter/ubuntu1404"
          ...
          server04.vm.network "private_network", virtualbox__intnet: 'wbXnet45', auto_config: false, :mac => "A00000000034"

          # Local_Interface: eth1 Topology_File_Line(21): "server04":"eth1" -- "leaf03":"swp2"
          server04.vm.network "private_network", virtualbox__intnet: 'wbXnet21', auto_config: false

          # Local_Interface: eth2 Topology_File_Line(22): "server04":"eth2" -- "leaf04":"swp2"
          server04.vm.network "private_network", virtualbox__intnet: 'wbXnet22', auto_config: false
  ...
  config.vm.define "leaf01" do |leaf01|
      ...
      leaf01.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet46', auto_config: false, :mac => "A00000000011"

          # Local_Interface: swp1 Topology_File_Line(15): "server01":"eth1" -- "leaf01":"swp1"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet15', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(17): "server02":"eth1" -- "leaf01":"swp2"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet17', auto_config: false

          # Local_Interface: swp45 Topology_File_Line(33): "leaf01":"swp45" -- "leaf01":"swp46"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet33', auto_config: false
          ...
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet34', auto_config: false
          ...
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet9', auto_config: false

          # Local_Interface: swp50 Topology_File_Line(10): "leaf01":"swp50" -- "leaf02":"swp50"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet10', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(1): "leaf01":"swp51" -- "spine01":"swp1"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet1', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(5): "leaf01":"swp52" -- "spine02":"swp1"
          leaf01.vm.network "private_network", virtualbox__intnet: 'wbXnet5', auto_config: false
  ...
  config.vm.define "leaf02" do |leaf02|
      ...
      leaf02.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet47', auto_config: false, :mac => "A00000000012"

          # Local_Interface: swp1 Topology_File_Line(16): "server01":"eth2" -- "leaf02":"swp1"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet16', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(18): "server02":"eth2" -- "leaf02":"swp2"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet18', auto_config: false

          # Local_Interface: swp45 Topology_File_Line(35): "leaf02":"swp45" -- "leaf02":"swp46"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet35', auto_config: false
          ...
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet36', auto_config: false

          # Local_Interface: swp48 Topology_File_Line(36): "leaf02":"swp47" -- "leaf02":"swp48"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet36', auto_config: false

          # Local_Interface: swp49 Topology_File_Line(9): "leaf01":"swp49" -- "leaf02":"swp49"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet9', auto_config: false

          # Local_Interface: swp50 Topology_File_Line(10): "leaf01":"swp50" -- "leaf02":"swp50"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet10', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(2): "leaf02":"swp51" -- "spine01":"swp2"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet2', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(6): "leaf02":"swp52" -- "spine02":"swp2"
          leaf02.vm.network "private_network", virtualbox__intnet: 'wbXnet6', auto_config: false
  ...
  config.vm.define "leaf03" do |leaf03|
      ...
      leaf03.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet48', auto_config: false, :mac => "A00000000013"

          # Local_Interface: swp1 Topology_File_Line(19): "server03":"eth1" -- "leaf03":"swp1"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet19', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(21): "server04":"eth1" -- "leaf03":"swp2"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet21', auto_config: false

          # Local_Interface: swp45 Topology_File_Line(37): "leaf03":"swp45" -- "leaf03":"swp46"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet37', auto_config: false
          ...
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet38', auto_config: false
          ...
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet11', auto_config: false

          # Local_Interface: swp50 Topology_File_Line(12): "leaf03":"swp50" -- "leaf04":"swp50"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet12', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(3): "leaf03":"swp51" -- "spine01":"swp3"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet3', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(7): "leaf03":"swp52" -- "spine02":"swp3"
          leaf03.vm.network "private_network", virtualbox__intnet: 'wbXnet7', auto_config: false
  ...
  config.vm.define "leaf04" do |leaf04|
      ...
      leaf04.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet49', auto_config: false, :mac => "A00000000014"

          # Local_Interface: swp1 Topology_File_Line(20): "server03":"eth2" -- "leaf04":"swp1"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet20', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(22): "server04":"eth2" -- "leaf04":"swp2"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet22', auto_config: false

          # Local_Interface: swp45 Topology_File_Line(39): "leaf04":"swp45" -- "leaf04":"swp46"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet39', auto_config: false
          ...
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet40', auto_config: false

          # Local_Interface: swp48 Topology_File_Line(40): "leaf04":"swp47" -- "leaf04":"swp48"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet40', auto_config: false

          # Local_Interface: swp49 Topology_File_Line(11): "leaf03":"swp49" -- "leaf04":"swp49"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet11', auto_config: false

          # Local_Interface: swp50 Topology_File_Line(12): "leaf03":"swp50" -- "leaf04":"swp50"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet12', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(4): "leaf04":"swp51" -- "spine01":"swp4"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet4', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(8): "leaf04":"swp52" -- "spine02":"swp4"
          leaf04.vm.network "private_network", virtualbox__intnet: 'wbXnet8', auto_config: false
  ...
  config.vm.define "spine01" do |spine01|
      ...
      spine01.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet50', auto_config: false, :mac => "A00000000021"

          # Local_Interface: swp1 Topology_File_Line(1): "leaf01":"swp51" -- "spine01":"swp1"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet1', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(2): "leaf02":"swp51" -- "spine01":"swp2"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet2', auto_config: false

          # Local_Interface: swp3 Topology_File_Line(3): "leaf03":"swp51" -- "spine01":"swp3"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet3', auto_config: false

          # Local_Interface: swp4 Topology_File_Line(4): "leaf04":"swp51" -- "spine01":"swp4"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet4', auto_config: false

          # Local_Interface: swp29 Topology_File_Line(25): "exit02":"swp51" -- "spine01":"swp29"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet25', auto_config: false

          # Local_Interface: swp30 Topology_File_Line(23): "exit01":"swp51" -- "spine01":"swp30"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet23', auto_config: false

          # Local_Interface: swp31 Topology_File_Line(13): "spine01":"swp31" -- "spine02":"swp31"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet13', auto_config: false

          # Local_Interface: swp32 Topology_File_Line(14): "spine01":"swp32" -- "spine02":"swp32"
          spine01.vm.network "private_network", virtualbox__intnet: 'wbXnet14', auto_config: false
  ...
  config.vm.define "spine02" do |spine02|
      ...
      spine02.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet51', auto_config: false, :mac => "A00000000022"

          # Local_Interface: swp1 Topology_File_Line(5): "leaf01":"swp52" -- "spine02":"swp1"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet5', auto_config: false

          # Local_Interface: swp2 Topology_File_Line(6): "leaf02":"swp52" -- "spine02":"swp2"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet6', auto_config: false

          # Local_Interface: swp3 Topology_File_Line(7): "leaf03":"swp52" -- "spine02":"swp3"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet7', auto_config: false

          # Local_Interface: swp4 Topology_File_Line(8): "leaf04":"swp52" -- "spine02":"swp4"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet8', auto_config: false

          # Local_Interface: swp29 Topology_File_Line(26): "exit02":"swp52" -- "spine02":"swp29"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet26', auto_config: false

          # Local_Interface: swp30 Topology_File_Line(24): "exit01":"swp52" -- "spine02":"swp30"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet24', auto_config: false

          # Local_Interface: swp31 Topology_File_Line(13): "spine01":"swp31" -- "spine02":"swp31"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet13', auto_config: false

          # Local_Interface: swp32 Topology_File_Line(14): "spine01":"swp32" -- "spine02":"swp32"
          spine02.vm.network "private_network", virtualbox__intnet: 'wbXnet14', auto_config: false
  ...
  config.vm.define "exit01" do |exit01|
      ...
      exit01.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet52', auto_config: false, :mac => "A00000000041"

          # Local_Interface: swp45 Topology_File_Line(29): "exit01":"swp45" -- "exit01":"swp46"
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet29', auto_config: false
          ...
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet30', auto_config: false
          ...
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet27', auto_config: false

          # Local_Interface: swp49 Topology_File_Line(27): "exit01":"swp49" -- "exit01":"swp49"
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet27', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(23): "exit01":"swp51" -- "spine01":"swp30"
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet23', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(24): "exit01":"swp52" -- "spine02":"swp30"
          exit01.vm.network "private_network", virtualbox__intnet: 'wbXnet24', auto_config: false
  ...
  config.vm.define "exit02" do |exit02|
      ...
      exit02.vm.box = "CumulusCommunity/cumulus-vx"
          ...
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet53', auto_config: false, :mac => "A00000000042"

          # Local_Interface: swp45 Topology_File_Line(31): "exit02":"swp45" -- "exit02":"swp46"
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet31', auto_config: false
          ...
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet32', auto_config: false
          ...
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet28', auto_config: false

          # Local_Interface: swp50 Topology_File_Line(28): "exit02":"swp50" -- "exit02":"swp50"
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet28', auto_config: false

          # Local_Interface: swp51 Topology_File_Line(25): "exit02":"swp51" -- "spine01":"swp29"
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet25', auto_config: false

          # Local_Interface: swp52 Topology_File_Line(26): "exit02":"swp52" -- "spine02":"swp29"
          exit02.vm.network "private_network", virtualbox__intnet: 'wbXnet26', auto_config: false
